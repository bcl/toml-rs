...
impl ser::Serializer for Serializer {
    ...
    type SerializeTuple = ::ser::Impossible<Value>;
    type SerializeTupleStruct = ::ser::Impossible<Value>;
    type SerializeTupleVariant = ::ser::Impossible<Value>;
    type SerializeMap = SerializeMap;
    type SerializeStruct = SerializeMap;
    type SerializeStructVariant = ::ser::Impossible<Value>;
